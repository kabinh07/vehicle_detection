...
class ModelHandler:
    ...
    def preprocess(self, data):
        ...
        transform = transforms.Compose([transforms.Resize((ModelHandler.img_size, ModelHandler.img_size)), transforms.ToImage(), transforms.ToDtype(torch.float32, scale=True)])
        img = transform(image)
